  ...
  makers: [
    ...
    { name: "@electron-forge/maker-zip", platforms: ["darwin"] },
    {
      ...
      config: {
        ...
        iconUrl: "https://raw.githubusercontent.com/MAE5blog/ChatGPTDesktop-Rebuild/master/resources/electron.ico",
      },
    },
    { name: "@electron-forge/maker-zip", platforms: ["win32"] },
    {
      name: "@electron-forge/maker-deb",
      config: { options: { name: "codex", productName: "Codex", genericName: "AI Coding Assistant", categories: ["Development", "Utility"], bin: "Codex", maintainer: "MAE5", homepage: "https://github.com/MAE5blog/ChatGPTDesktop-Rebuild", icon: "./resources/electron.png" } },
    },
    {
      ...
      config: {
        options: {
          ...
          bin: "Codex",
          license: "Apache-2.0",
          homepage: "https://github.com/MAE5blog/ChatGPTDesktop-Rebuild",
